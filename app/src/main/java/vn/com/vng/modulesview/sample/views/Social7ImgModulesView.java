...
public class Social7ImgModulesView extends SocialModulesView {
    public Social7ImgModulesView(Context context) {
        super(context);
    }

    public Social7ImgModulesView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public Social7ImgModulesView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public Social7ImgModulesView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        img4.setBounds(temp + dp(1), temp + top + dp(1), widthSize, top+ widthSize);
        ...
        img1.setBounds(0,               top,                          temp1 - dp(1),        top + temp2 - dp(1) );
        img2.setBounds(0,               top + temp2 + dp(1),          temp1 - dp(1),        top + temp1 - dp(1) );
        img3.setBounds(0,               temp1 + top + dp(1),          temp2 - dp(1),        top + widthSize);
        img4.setBounds(temp2 + dp(1),   temp1 + top + dp(1),          temp2 +temp2 - dp(1), top + widthSize);
        img5.setBounds(temp1 + dp(1),   top,                          widthSize,            top + temp2 - dp(1));
        img6.setBounds(temp1 + dp(1),   top + temp2 + dp(1),          widthSize,            top + temp2 + temp2- dp(1));
        img7.setBounds(temp1 + dp(1),   top + temp2 +temp2 + dp(1),   widthSize,            top + widthSize);
