...
public class Social8ImageContentView extends SocialImageContentView {
    ...
    protected int configModulesOnMeasure(List<ImageModule> imageModules) {
        ...
        img2.setBounds(temp2 + dp(1),   0,                      temp1 - dp(1),        temp2 - dp(1) );
        img3.setBounds(temp2 + dp(1),   temp2 + dp(1),          temp1 - dp(1),        temp1 - dp(1) );
        img4.setBounds(0,               temp1 + dp(1),          temp2 - dp(1),        widthSize);
        img5.setBounds(temp2 + dp(1),   temp1 + dp(1),          temp2 +temp2 - dp(1), widthSize);
        img6.setBounds(temp1 + dp(1),   0,                          widthSize,        temp2 - dp(1));
        img7.setBounds(temp1 + dp(1),   temp2 + dp(1),          widthSize,            temp2 + temp2- dp(1));
        img8.setBounds(temp1 + dp(1),   temp2 +temp2 + dp(1),   widthSize,            widthSize);
