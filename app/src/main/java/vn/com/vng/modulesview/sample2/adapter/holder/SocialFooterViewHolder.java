...
public class SocialFooterViewHolder extends BaseViewHolder {
    ...
    public void onBind(BaseViewItem item) {
        super.onBind(item);
        if(item instanceof SocialFooterViewItem)
            mSocialFooterView.bindModel(((SocialFooterViewItem) item).getSocialModel());
    }
}
